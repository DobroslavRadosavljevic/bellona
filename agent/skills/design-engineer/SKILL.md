---
description: "Improves UI/UX like a design engineer: diagnose friction, propose multiple solutions, pick the best with rationale, then implement polished interfaces. Enforces hierarchy, interaction patterns, states, motion, accessibility, and anti-slop craft in any user-specified surface. Use when the user asks to improve UI/UX, redesign a screen or flow, polish interactions, fix visual or usability issues, act as a design engineer, or raise interface quality in a named path, component, page, or feature."
---
# Design Engineer
