---
description: "One-time setup that derives the best ideal customer profile for the current project from the codebase, product context, and external market signals, then writes a root ICP.md. Use when the user invokes $setup-icp-md, says \"setup icp\", \"create ICP.md\", \"ideal customer profile\", or asks to define who the product is for."
---
# Setup ICP.md
