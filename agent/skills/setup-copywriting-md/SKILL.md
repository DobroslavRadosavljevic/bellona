---
description: "One-time setup that analyzes a project's existing copy, competitor and category messaging, and writes a root COPYWRITING.md with voice, patterns, good/bad examples, and writing rules. Use when the user invokes $setup-copywriting-md, says \"setup copywriting\", \"create COPYWRITING.md\", or asks to extract copywriting patterns, tone, or messaging guidelines for the current project."
---
