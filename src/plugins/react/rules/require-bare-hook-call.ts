...
export const requireBareHookCall: CreateOnceRule = defineBellonaRule({
  meta: {
    type: 'problem',
    docs: {
      description: 'Require a React hook call to be the whole assignment or a standalone statement',
    },
    messages: {
      notBare: agentDiagnostic({
        ...
        fix: 'Write `const tags = useSomethingTags();` then handle null or array in the next lines.',
        avoid:
