...
Plugin name: `tanstack-router`. Ids: `tanstack-router/bn-<slug>`.
...
## `tanstack-router/bn-create-route-property-order`
...
## `tanstack-router/bn-no-dynamic-router-to`
...
## `tanstack-router/bn-no-get-route-api`
...
## `tanstack-router/bn-no-hooks-in-route-lifecycle`
...
## `tanstack-router/bn-no-imperative-location-navigation`
...
## `tanstack-router/bn-no-relative-router-to-without-from`

Relative `to` (`./`, `../`, or empty) requires `from` (`from={Route.fullPath}` or `useNavigate({ from })`).

## `tanstack-router/bn-no-router-href`
...
## `tanstack-router/bn-no-router-type-assertion`
